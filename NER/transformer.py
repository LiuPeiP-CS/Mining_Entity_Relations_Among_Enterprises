...
class MultiHeadAttention(nn.Module):
    def __init__(self, head_num, model_dim, dropout=0.1):
        ...
        # self.linear_q = clones(nn.Linear(model_dim, model_dim), 4)
        # self.linear_k = clones(nn.Linear(model_dim, model_dim), 4)
        # self.linear_v = clones(nn.Linear(model_dim, model_dim), 4)
...
class AttentionModel(nn.Module):
    def __init__(self, input_dim, model_dim, ff_dim, num_head, num_layer, dropout, device):
